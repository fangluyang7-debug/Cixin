...
页面采用 Vite 多页面入口，不影响原有评委入口：

```text
apps/judge-entry-web/product-pool.html
apps/judge-entry-web/src/product-pool/admin.ts
apps/judge-entry-web/src/product-pool/admin.css
```
