  ...
  <div class="ops-app">
    <header class="ops-header">
      ...
      <div class="header-config">
        ...
        <label class="token-field"><span>维护 Token</span><input id="maintenanceToken" type="password" value="${escapeHtml(defaultToken)}" placeholder="本地 mock 可留空" /></label>
...
function isCloudApiBase(value: string) {
  return /apiserver\.zeabur\.app/i.test(value);
}
